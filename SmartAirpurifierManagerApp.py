    ...
    def check_conditions(self):
        try:
            ...
            if self.temperature > 28 or self.dust > 22 or self.time == "03":
                self.publish_to(publish_topic, "It's time to filter the air")
                logging.info("Condition met: Air filter message published")
        except Exception as e:
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('SmartAirpurifierApp')
